...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xd:doc id="root" scope="stylesheet">
        ...
        <xd:param name="in-xml"/>
    </xd:doc>
    <xsl:template match="/">
        <xsl:param name="in-xml" select="f:change-element-ns-deep(//marc:Collection/marc:record[descendant-or-self::node()], 'https://www.loc.gov/MARC21/slim', 'marc')"/>
        <xsl:choose>
            <xsl:when test="//marc:collection/marc:record">
                <xsl:call-template name="marcPrefix">
                    <xsl:with-param name="marcPrefixed">
...
-->
    ...
    <xd:doc id="marcPrefixes" scope="component">
        <xd:desc>marcPrefixes</xd:desc>
    </xd:doc>
