...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xd:doc id="marcPrefix-root" scope="stylesheet">
        <xd:desc>Processes the marcRecord template</xd:desc>
        <xd:param name="marcPrefixedElement"/>
    </xd:doc>
    <xsl:template name="marcPrefix" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:param name="marcPrefixedElement" select="f:add-marc-prefix(//marc:collection/marc:record[descendant-or-self::node()])"/>
                    <modsCollection xmlns="http://www.loc.gov/mods/v3"
                        ...
                        <xsl:for-each select="//marc:collection/marc:record">
                            <mods version="3.4">
                                <xsl:call-template name="marcPrefix-marcRecord"/>
                            </mods>
                        </xsl:for-each>
                    </modsCollection>
                
    </xsl:template>
    <xd:doc id="marcPrefix-marcRecord" scope="component">
        <xd:desc>marcRecord</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-marcRecord" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        ...
        <xsl:for-each select="marc:datafield[@tag = '245']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom245" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '210']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom210" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '246']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom246" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '240']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom240" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '740']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom740" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '130']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom130" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '730']">
            <xsl:call-template name="marcPrefix-createTitleInfoFrom730" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>/>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '242']">
            <titleInfo type="translated">
                ...
                <!-- 1/04 fix -->
                <xsl:call-template name="marcPrefix-subtitle"/>
                <xsl:call-template name="marcPrefix-part"/>
            </titleInfo>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '100']">
            <xsl:call-template name="marcPrefix-createNameFrom100"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '110']">
            <xsl:call-template name="marcPrefix-createNameFrom110"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '111']">
            <xsl:call-template name="marcPrefix-createNameFrom111"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '700']">
            <xsl:call-template name="marcPrefix-createNameFrom700"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '710']">
            <xsl:call-template name="marcPrefix-createNameFrom710"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '711']">
            <xsl:call-template name="marcPrefix-createNameFrom711"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = '720']">
            <xsl:call-template name="marcPrefix-createNameFrom720"/>
        </xsl:for-each>

        <!--old 7XXs
		<xsl:for-each select="marc:datafield[@tag='700'][not(marc:subfield[@code='t'])]">
			<name type="personal">
				<xsl:call-template name="marcPrefix-nameABCDQ"/>
				<xsl:call-template name="marcPrefix-affiliation"/>
				<xsl:call-template name="marcPrefix-role"/>
			</name>
		</xsl:for-each>
		<xsl:for-each select="marc:datafield[@tag='710'][not(marc:subfield[@code='t'])]">
			<name type="corporate">
				<xsl:call-template name="marcPrefix-nameABCDN"/>
				<xsl:call-template name="marcPrefix-role"/>
			</name>
		</xsl:for-each>
		<xsl:for-each select="marc:datafield[@tag='711'][not(marc:subfield[@code='t'])]">
			<name type="conference">
				<xsl:call-template name="marcPrefix-nameACDEQ"/>
				<xsl:call-template name="marcPrefix-role"/>
			</name>
		</xsl:for-each>
...
-->
        ...
        <xsl:for-each select="marc:datafield[@tag = 047]">
            <xsl:call-template name="marcPrefix-createGenreFrom047"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = 336]">
            <xsl:call-template name="marcPrefix-createGenreFrom336"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = 655]">
            <xsl:call-template name="marcPrefix-createGenreFrom655"/>
        </xsl:for-each>
    ...
    -->
            ...
            <xsl:choose>
                ...
                <xsl:when
                    ...
                    <!-- use substring to limit for dates-->                   <xsl:variable name="controlField008-0-14"
            ...
            <xsl:if
                ...
                <xsl:for-each select="marcPrefix-leader">
                    <issuance>
                        <!-- 2.08 cm3 -->
                        <xsl:choose>
                            <xsl:when
        ...
        <xsl:for-each select="marc:datafield[@tag = 264][@ind2 = 0]">
            ...
            <originInfo displayLabel="producer">
                ...
                <xsl:call-template name="marcPrefix-xxx880"/>
        ...
        <xsl:for-each select="marc:datafield[@tag = 264][@ind2 = 1]">
            <originInfo displayLabel="publisher">
                ...
                <publisher>
                    <xsl:value-of select="substring-before(marc:subfield[@code = 'b'], ',')"/>
                </publisher>
                <dateIssued>
                    <xsl:value-of select="substring-before(marc:subfield[@code = 'c'], '.')"/>
                </dateIssued>
            </originInfo>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = 880]">
            <xsl:variable name="related_marc:datafield"
            ...
            <xsl:variable name="hit"
                select="../marc:datafield[@tag = $related_marc:datafield and contains(marc:subfield[@code = '6'], concat('880-', $occurence_number))]/@tag"/>
            ...
            <xsl:choose>
                ...
                <xsl:when test="$hit = '300'">
                    <physicalDescription>
                        <xsl:for-each select="marcPrefix-../marc:datafield[@tag = 300]">
                            <xsl:call-template name="marcPrefix-z3xx880"/>
                        </xsl:for-each>
                        <extent>
                            <xsl:for-each select="marcPrefix-subfield">
                                <xsl:if
            ...
            <xsl:for-each
                ...
                <xsl:choose>
                    <xsl:when test="../marc:subfield[@code = '2'] = 'rfc3066'">
                        ...
                        <xsl:call-template name="marcPrefix-rfcLanguages">
                    ...
                    <xsl:otherwise>
                        ...
                        <xsl:call-template name="marcPrefix-isoLanguage">
        ...
        <xsl:variable name="physicalDescription">
            ...
            <xsl:if test="marc:datafield[@tag = 130]/marc:subfield[@code = 'h']">
                <form authority="gmd">
                    <xsl:call-template name="marcPrefix-chopBrackets">
                        <xsl:with-param name="chopString">
        ...
        <xsl:for-each select="marc:datafield[@tag = 520]">
            <xsl:call-template name="marcPrefix-createAbstractFrom520"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 505]">
            <xsl:call-template name="marcPrefix-createTOCFrom505"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 521]">
            <xsl:call-template name="marcPrefix-createTargetAudienceFrom521"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 506]">
            <xsl:call-template name="marcPrefix-createAccessConditionFrom506"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 540]">
            <xsl:call-template name="marcPrefix-createAccessConditionFrom540"/>
        </xsl:for-each>
		...
		<xsl:for-each select="marc:datafield[@tag=510]">
			<note type="citation/reference">
				<xsl:call-template name="marcPrefix-uri"/>
        ...
        <xsl:if test="marc:datafield[@tag = 245]/marc:subfield[@code = 'c']">
            <xsl:for-each select="marc:datafield[@tag = 245]">
                <xsl:call-template name="marcPrefix-createNoteFrom245c"/>
            </xsl:for-each>
        </xsl:if>

        <xsl:for-each select="marc:datafield[@tag = 362]">
            <xsl:call-template name="marcPrefix-createNoteFrom362"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 500]">
            <xsl:call-template name="marcPrefix-createNoteFrom500"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 502]">
            <xsl:call-template name="marcPrefix-createNoteFrom502"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 504]">
            <xsl:call-template name="marcPrefix-createNoteFrom504"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 508]">
            <xsl:call-template name="marcPrefix-createNoteFrom508"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 511]">
            <xsl:call-template name="marcPrefix-createNoteFrom511"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 515]">
            <xsl:call-template name="marcPrefix-createNoteFrom515"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 518]">
            <xsl:call-template name="marcPrefix-createNoteFrom518"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 524]">
            <xsl:call-template name="marcPrefix-createNoteFrom524"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 530]">
            <xsl:call-template name="marcPrefix-createNoteFrom530"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 533]">
            <xsl:call-template name="marcPrefix-createNoteFrom533"/>
        </xsl:for-each>
        <!--
		<xsl:for-each select="marc:datafield[@tag=534]">
			<xsl:call-template name="marcPrefix-createNoteFrom534"/>
		</xsl:for-each>
-->

        <xsl:for-each select="marc:datafield[@tag = 535]">
            <xsl:call-template name="marcPrefix-createNoteFrom535"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 536]">
            <xsl:call-template name="marcPrefix-createNoteFrom536"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 538]">
            <xsl:call-template name="marcPrefix-createNoteFrom538"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 541]">
            <xsl:call-template name="marcPrefix-createNoteFrom541"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 545]">
            <xsl:call-template name="marcPrefix-createNoteFrom545"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 546]">
            <xsl:call-template name="marcPrefix-createNoteFrom546"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 561]">
            <xsl:call-template name="marcPrefix-createNoteFrom561"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 562]">
            <xsl:call-template name="marcPrefix-createNoteFrom562"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 581]">
            <xsl:call-template name="marcPrefix-createNoteFrom581"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 583]">
            <xsl:call-template name="marcPrefix-createNoteFrom583"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 585]">
            <xsl:call-template name="marcPrefix-createNoteFrom585"/>
        </xsl:for-each>
        ...
        <xsl:for-each
            ...
            <xsl:call-template name="marcPrefix-createNoteFrom5XX"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 034]">
            <xsl:call-template name="marcPrefix-createSubGeoFrom034"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 043]">
            <xsl:call-template name="marcPrefix-createSubGeoFrom043"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 045]">
            <xsl:call-template name="marcPrefix-createSubTemFrom045"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 255]">
            <xsl:call-template name="marcPrefix-createSubGeoFrom255"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 600]">
            <xsl:call-template name="marcPrefix-createSubNameFrom600"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 610]">
            <xsl:call-template name="marcPrefix-createSubNameFrom610"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 611]">
            <xsl:call-template name="marcPrefix-createSubNameFrom611"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 630]">
            <xsl:call-template name="marcPrefix-createSubTitleFrom630"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 648]">
            <xsl:call-template name="marcPrefix-createSubChronFrom648"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 650]">
            <xsl:call-template name="marcPrefix-createSubTopFrom650"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 651]">
            <xsl:call-template name="marcPrefix-createSubGeoFrom651"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 653]">
            <xsl:call-template name="marcPrefix-createSubFrom653"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 656]">
            <xsl:call-template name="marcPrefix-createSubFrom656"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 662]">
            <xsl:call-template name="marcPrefix-createSubGeoFrom662752"/>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '050']">
            <xsl:call-template name="marcPrefix-createClassificationFrom050"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = '060']">
            <xsl:call-template name="marcPrefix-createClassificationFrom060"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = '080']">
            <xsl:call-template name="marcPrefix-createClassificationFrom080"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = '082']">
            <xsl:call-template name="marcPrefix-createClassificationFrom082"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = '084']">
            <xsl:call-template name="marcPrefix-createClassificationFrom084"/>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = '086']">
            <xsl:call-template name="marcPrefix-createClassificationFrom086"/>
        </xsl:for-each>
        ...
        <xsl:if test="marc:datafield[@tag = 070][@ind1 = '0']/marc:subfield[@code = 'a']">
            <classification authority="nal">
                ...
                <xsl:if test="marc:datafield[@tag = 070]/marc:subfield[@code = 'b']">
                    <xsl:text>&#160;</xsl:text>
                    <xsl:value-of select="marc:datafield[@tag = 070]/marc:subfield[@code = 'b']"/>
                </xsl:if>
            </classification>
        </xsl:if>
        ...
        <xsl:for-each select="marc:datafield[@tag = 852]">
            <xsl:call-template name="marcPrefix-createLocationFrom852"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 856]">
            <xsl:call-template name="marcPrefix-createLocationFrom856"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 490][@ind1 = '0']">
            <xsl:call-template name="marcPrefix-createRelatedItemFrom490"/>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = 534]">
            <relatedItem type="original">
                <xsl:call-template name="marcPrefix-relatedTitle"/>
                <xsl:call-template name="marcPrefix-relatedName"/>
                ...
                <xsl:call-template name="marcPrefix-relatedIdentifierISSN"/>
                <xsl:for-each select="marc:subfield[@code = 'z']">
                    <identifier type="isbn">
                        <xsl:value-of select="."/>
                    </identifier>
                </xsl:for-each>
                <xsl:call-template name="marcPrefix-relatedNote"/>
            </relatedItem>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag = 700][marc:subfield[@code = 't']]">
            <relatedItem>
                <xsl:call-template name="marcPrefix-constituentOrRelatedType"/>
                <titleInfo>
                    <title>
                        <xsl:call-template name="chopPunctuation">
                            <xsl:with-param name="chopString">
                                <xsl:call-template name="marcPrefix-specialSubfieldSelect">
                ...
                <name type="personal">
                    ...
                    <xsl:call-template name="marcPrefix-termsOfAddress"/>
                    <xsl:call-template name="marcPrefix-nameDate"/>
                    <xsl:call-template name="marcPrefix-role"/>
                </name>
                <xsl:call-template name="marcPrefix-relatedForm"/>
                <xsl:call-template name="marcPrefix-relatedIdentifierISSN"/>
            </relatedItem>
        </xsl:for-each>
        <xsl:for-each select="marc:datafield[@tag = 710][marc:subfield[@code = 't']]">
            <relatedItem>
                ...
                <titleInfo>
                    ...
                    <xsl:call-template name="marcPrefix-relatedPartNumName"/>
                </titleInfo>
                <name type="corporate">
                    <xsl:for-each select="marc:subfield[@code = 'a']">
                        <namePart>
        ...
        <xsl:for-each select="marc:datafield[@tag = 760]">
            <relatedItem type="series">
                <xsl:call-template name="marcPrefix-relatedItem76X-78X"/>
            </relatedItem>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '020']">
            <xsl:if test="marc:subfield[@code = 'z']">
                <identifier type="isbn" invalid="marcPrefix-yes">
        ...
        <xsl:for-each select="marc:datafield[@tag = '022'][marc:subfield[@code = 'z']]">
            <xsl:if test="marc:subfield[@code = 'z']">
                <identifier type="issn" invalid="marcPrefix-yes">
                    <xsl:value-of select="marc:subfield[@code = 'z']"/>
                </identifier>
            </xsl:if>
        </xsl:for-each>
        ...
        <xsl:for-each select="marc:datafield[@tag = '022'][marc:subfield[@code = 'm']]">
            <xsl:if test="marc:subfield[@code = 'm']">
                <identifier type="issn-l" invalid="marcPrefix-yes">
        ...
        <xsl:for-each select="marc:datafield[@tag = '010'][marc:subfield[@code = 'z']]">
            <identifier type="lccn" invalid="marcPrefix-yes">
        ...
        <extension>
            <xsl:call-template name="marcPrefix-createNoteFrom910"/>
            <xsl:call-template name="marcPrefix-createNoteFrom930"/>
            <xsl:call-template name="marcPrefix-createNoteFrom945"/>
            <xsl:call-template name="marcPrefix-createNoteFrom946"/>
            <xsl:call-template name="marcPrefix-createNoteFrom974"/>
        </extension>

        <recordInfo>
            <xsl:for-each select="marcPrefix-leader[substring($marcLeader, 19, 1) = 'a']">
            ...
            <xsl:for-each select="marc:marc:datafield[@tag = 040]/marc:subfield[@code = 'b']">
...
<!--marcRecord ends -->
    <xd:doc id="marcPrefix-displayForm" scope="component">
        <xd:desc>displayForm</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-displayForm" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-affiliation" scope="component">
        <xd:desc>affiliation</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-affiliation" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-uri" scope="component">
        <xd:desc>uri</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-uri" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-role" scope="component">
        <xd:desc>role</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-role" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-part" scope="component">
        <xd:desc>part</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-part" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedPart" scope="component">
        <xd:desc>relatedPart</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedPart" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        ...
        <xsl:if test="@tag = 773">
            ...
            <xsl:for-each select="marc:subfield[@code = 'q']">
                <part>
                    <xsl:call-template name="marcPrefix-parsePart"/>
                </part>
            </xsl:for-each>
        </xsl:if>
    </xsl:template>
    <xd:doc id="marcPrefix-relatedPartNumName" scope="component">
        <xd:desc>relatedPartNumName</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedPartNumName" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedName" scope="component">
        <xd:desc>relatedName</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedName" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedForm" scope="component">
        <xd:desc>relatedForm</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedForm" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedExtent" scope="component">
        <xd:desc>relatedExtent</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedExtent" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedNote" scope="component">
        <xd:desc>relatedNote</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedNote" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedSubject" scope="component">
        <xd:desc>relatedSubject</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedSubject" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <!--Revision 2.10 added condtional statement if ISSN is empty from 773, use 914 subfield b cm3 12/09/2022-->
    <xd:doc id="marcPrefix-relatedIdentifierISSN" scope="component">
        <xd:desc>relatedIdentifierISSN</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedIdentifierISSN" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:choose>
            ...
            <xsl:when test="../marc:datafield[@tag = 914]/marc:subfield[@code = 'b'] != ''">
                <xsl:for-each select="marcPrefix-../marc:datafield[@tag = 914]/marc:subfield[@code = 'b']">
                    <identifier type="issn">
                        <xsl:value-of select="."/>
                    </identifier>
                </xsl:for-each>
    ...
    <!--Revision 2.11 added condtional statement if agid:# is empty from 773, use 914 subfield a cm3 12/09/2022-->
    <xd:doc id="marcPrefix-relatedIdentifierLocal" scope="component">
        <xd:desc>relatedIdentifierLocal</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedIdentifierLocal" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:for-each select="marcPrefix-../marc:datafield[@tag = 914]/marc:subfield[@code = 'a']">
                    <identifier type="local">
                        <xsl:value-of select="."/>
                    </identifier>
                </xsl:for-each>
    ...
    <xd:doc id="marcPrefix-relatedIdentifier" scope="component">
        <xd:desc>relatedIdentifier</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedIdentifier" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedItem510" scope="component">
        <xd:desc>tmee 1.40 510 isReferencedBy </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedItem510" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:call-template name="marcPrefix-displayLabel"/>
        <xsl:call-template name="marcPrefix-relatedTitle76X-78X"/>
        <xsl:call-template name="marcPrefix-relatedName"/>
        <!--<xsl:call-template name="marcPrefix-relatedOriginInfo510"/>-->
        <xsl:call-template name="marcPrefix-relatedLanguage"/>
        <xsl:call-template name="marcPrefix-relatedExtent"/>
        <xsl:call-template name="marcPrefix-relatedNote"/>
        <xsl:call-template name="marcPrefix-relatedSubject"/>
        <xsl:call-template name="marcPrefix-relatedIdentifier"/>
        <xsl:call-template name="marcPrefix-relatedIdentifierISSN"/>
        <xsl:call-template name="marcPrefix-relatedIdentifierLocal"/>
        <xsl:call-template name="marcPrefix-relatedPart"/>
    </xsl:template>
    <xd:doc>
        <xd:desc/>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedItem76X-78X" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:call-template name="marcPrefix-displayLabel"/>
        <xsl:call-template name="marcPrefix-relatedTitle76X-78X"/>
        <xsl:call-template name="marcPrefix-relatedName"/>
        <!--<xsl:call-template name="marcPrefix-relatedOriginInfo"/>-->
        <xsl:call-template name="marcPrefix-relatedLanguage"/>
        <xsl:call-template name="marcPrefix-relatedExtent"/>
        <xsl:call-template name="marcPrefix-relatedNote"/>
        <xsl:call-template name="marcPrefix-relatedSubject"/>
    ...
    <xd:doc id="marcPrefix-subjectGeographicZ" scope="component">
        <xd:desc>subjectGeographicZ</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectGeographicZ" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-subjectTemporalY" scope="component">
        <xd:desc>subjectTemporalY</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectTemporalY" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-subjectTopic" scope="component">
        <xd:desc>subjectTopic</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectTopic" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-subjectGenre" scope="component">
        <xd:desc> 3.2 change tmee 6xx $v genre </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectGenre" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <genre>
            <xsl:call-template name="chopPunctuation">
                <xsl:with-param name="chopString" select="."/>
            </xsl:call-template>
    ...
    <xd:doc id="marcPrefix-nameABCDN" scope="component">
        <xd:desc>nameABCDN</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-nameABCDN" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-nameABCDQ" scope="component">
        <xd:desc>nameABCDQ</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-nameABCDQ" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-nameACDEQ" scope="component">
        <xd:desc>nameACDEQ</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-nameACDEQ" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-constituentOrRelatedType" scope="component">
        <xd:desc>constituentOrRelatedType</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-constituentOrRelatedType" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <xsl:if test="@ind2 = '2'">
            <xsl:attribute name="type">constituent</xsl:attribute>
        </xsl:if>
    </xsl:template>
    <xd:doc id="marcPrefix-relatedTitle" scope="component">
        <xd:desc>relatedTitle</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedTitle" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-relatedTitle76X-78X" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:for-each select="marc:subfield[@code = 't']">
            <titleInfo>
                <title>
                    <xsl:call-template name="chopPunctuation">
    ...
    <xd:doc id="marcPrefix-relatedOriginInfo" scope="component">
        <xd:desc>relatedOriginInfo</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedOriginInfo" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedOriginInfo510" scope="component">
        <xd:desc>relatedOriginInfo510</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedOriginInfo510" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-relatedLanguage" scope="component">
        <xd:desc>relatedLanguage</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-relatedLanguage" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <xsl:for-each select="marc:subfield[@code = 'e']">
            <xsl:call-template name="marcPrefix-getLanguage">
    ...
    <xd:doc id="marcPrefix-nameDate" scope="component">
        <xd:desc>nameDate</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-nameDate" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-subjectAuthority" scope="component">
        <xd:desc>subjectAuthority</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectAuthority" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-subject653Type" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:if test="@ind2 != ' '">
            <xsl:if test="@ind2 != '0'">
                <xsl:if test="@ind2 != '4'">
                    <xsl:if test="@ind2 != '5'">
    ...
    <xd:doc id="marcPrefix-subjectAnyOrder" scope="component">
        <xd:desc>subjectAnyOrder</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-subjectAnyOrder" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <xsl:for-each select="marc:subfield[@code = 'v' or @code = 'x' or @code = 'y' or @code = 'z']">
            <xsl:choose>
                <xsl:when test="@code = 'v'">
                    <xsl:call-template name="marcPrefix-subjectGenre"/>
                </xsl:when>
                <xsl:when test="@code = 'x'">
                    <xsl:call-template name="marcPrefix-subjectTopic"/>
                </xsl:when>
                <xsl:when test="@code = 'y'">
                    <xsl:call-template name="marcPrefix-subjectTemporalY"/>
                </xsl:when>
                <xsl:when test="@code = 'z'">
                    <xsl:call-template name="marcPrefix-subjectGeographicZ"/>
                </xsl:when>
            </xsl:choose>
        </xsl:for-each>
    </xsl:template>
    ...
    <xsl:template name="marcPrefix-specialSubfieldSelect" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-termsOfAddress" scope="component">
        <xd:desc>termsOfAddress</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-termsOfAddress" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-displayLabel" scope="component">
        <xd:desc>displayLabel</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-displayLabel" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
  ...
  <!--  <xd:doc>
    ...
    <xsl:template name="marcPrefix-isInvalid" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:param name="type"/>
    ...
    <xsl:template name="marcPrefix-subtitle" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:if test="marc:subfield[@code = 'b']">
            <subTitle>
                <xsl:call-template name="chopPunctuation">
                    <xsl:with-param name="chopString">
    ...
    <xsl:template name="marcPrefix-script" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-parsePart" scope="component">
        <xd:desc>parsePart</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-parsePart" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-getLanguage" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-isoLanguage" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-chopBrackets" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-rfcLanguages" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-dates045b" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:param name="str"/>
    ...
    <xd:doc id="marcPrefix-scriptCode" scope="component">
        <xd:desc>scriptCode</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-scriptCode" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-xxx880" scope="component">
        <xd:desc> tmee 20100927 for 880s &amp; corresponding fields 20101123 scriptCode </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-xxx880" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-yyy880" scope="component">
        <xd:desc>yyy880</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-yyy880" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-z2xx880" scope="component">
        <xd:desc>z2xx880</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-z2xx880" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-z3xx880" scope="component">
        <xd:desc>z3xx880</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-z3xx880" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-true880" scope="component">
        <xd:desc>true880</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-true880" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template match="marc:datafield" mode="trans880">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$sf06a = '210'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom210"/>
            </xsl:when>
            <xsl:when test="$sf06a = '245'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom245"/>
                <xsl:call-template name="marcPrefix-createNoteFrom245c"/>
            </xsl:when>
            <xsl:when test="$sf06a = '246'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom246"/>
            </xsl:when>
            <xsl:when test="$sf06a = '240'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom240"/>
            </xsl:when>
            <xsl:when test="$sf06a = '740'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom740"/>
            </xsl:when>

            <xsl:when test="$sf06a = '130'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom130"/>
            </xsl:when>
            <xsl:when test="$sf06a = '730'">
                <xsl:call-template name="marcPrefix-createTitleInfoFrom730"/>
            </xsl:when>
...
-->
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom130" scope="component">
        <xd:desc> 130 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom130" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom730" scope="component">
        <xd:desc>createTitleInfoFrom730</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom730" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom210" scope="component">
        <xd:desc>createTitleInfoFrom210</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom210" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom245" scope="component">
        <xd:desc> 1.79 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom245" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <titleInfo>
            <xsl:call-template name="marcPrefix-xxx880" xpath-default-namespace="http://www.loc.gov/MARC21/slim"> 
            <xsl:variable name="title">
                <xsl:choose>
                    <xsl:when test="marc:subfield[@code = 'b']">
                        <xsl:call-template name="marcPrefix-specialSubfieldSelect" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
                            <xsl:with-param name="axis">b</xsl:with-param>
                            <xsl:with-param name="beforeCodes">Afghans</xsl:with-param>
                        </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:call-template name="subfieldSelect" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
            ...
            <xsl:variable name="titleChop">
                <xsl:call-template name="chopPunctuation" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
                    <xsl:with-param name="chopString">
                        <xsl:value-of select="$title"/>
                    </xsl:with-param>
                </xsl:call-template>
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom246" scope="component">
        <xd:desc>createTitleInfoFrom246</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom246" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom240" scope="component">
        <xd:desc> 240 nameTitleGroup</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom240" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <titleInfo type="uniform">
            <xsl:if
    ...
    <xd:doc id="marcPrefix-createTitleInfoFrom740" scope="component">
        <xd:desc>createTitleInfoFrom740</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTitleInfoFrom740" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <titleInfo type="alternative">
            <xsl:call-template name="marcPrefix-xxx880"/>
            <title>
                <xsl:call-template name="chopPunctuation">
    ...
    <xd:doc id="marcPrefix-createNameFrom100" scope="component">
        <xd:desc> name 100 110 111 1.93 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom100" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:if test="@ind1 = '0' or @ind1 = '1'">
            <name type="personal">
                ...
                <!--<xsl:call-template name="marcPrefix-nameABCDQ"/>-->
                <xsl:call-template name="marcPrefix-displayForm"/>
                <xsl:call-template name="marcPrefix-affiliation"/>
                <xsl:call-template name="marcPrefix-role"/>
            </name>
        </xsl:if>
    ...
    <xd:doc id="marcPrefix-createNameFrom110" scope="component">
        <xd:desc>createNameFrom110</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom110" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <name type="corporate">
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:if test="//marc:datafield[@tag = '240']">
                <xsl:attribute name="nameTitleGroup">
    ...
    <xd:doc id="marcPrefix-createNameFrom111" scope="component">
        <xd:desc>createNameFrom111</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom111" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNameFrom700" scope="component">
        <xd:desc> name 700 710 711 720 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom700" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:if test="@ind1 = '1'">
            <name type="personal">
                <!--cm3 edit, Revision 2.06 added usage="primary" to <name> while checking if name in 100$a is present-->
                <xsl:if
                    test="position() = 1 and (count(./preceding-sibling::marc:subfield[@code = 'a']) = 0) and (count(//marc:datafield[@tag = 100]/marc:subfield[@code = 'a']) = 0)">
    ...
    <xd:doc id="marcPrefix-createNameFrom710" scope="component">
        <xd:desc>createNameFrom710</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom710" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNameFrom711" scope="component">
        <xd:desc>createNameFrom711</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom711" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNameFrom720" scope="component">
        <xd:desc>createNameFrom720</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom720" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createGenreFrom047" scope="component">
        <xd:desc> genre 047 336 655 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createGenreFrom047" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createGenreFrom336" scope="component">
        <xd:desc>createGenreFrom336</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createGenreFrom336" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <genre>
            <xsl:attribute name="authority">
                <xsl:value-of select="marc:subfield[@code = '2']"/>
            </xsl:attribute>
    ...
    <xd:doc id="marcPrefix-createGenreFrom655" scope="component">
        <xd:desc>createGenreFrom655</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createGenreFrom655" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <genre authority="marcgt">
            <xsl:attribute name="authority">
                <xsl:value-of select="marc:subfield[@code = '2']"/>
            </xsl:attribute>
    ...
    <xd:doc id="marcPrefix-createTOCFrom505" scope="component">
        <xd:desc> tOC 505 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTOCFrom505" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <tableOfContents>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-uri"/>
            <xsl:call-template name="subfieldSelect">
    ...
    <xsl:template name="marcPrefix-createAbstractFrom520" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <abstract>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-uri"/>
            <xsl:call-template name="subfieldSelect">
    ...
    <xd:doc id="marcPrefix-createTargetAudienceFrom521" scope="component">
        <xd:desc> targetAudience 521 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createTargetAudienceFrom521" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <targetAudience>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcSubfieldSelect">
                <xsl:with-param name="codes">ab</xsl:with-param>
            </xsl:call-template>
        </targetAudience>
    </xsl:template>
    <xd:doc id="marcPrefix-createNoteFrom245c" scope="component">
        <xd:desc> note 245c thru 585 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom245c" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom362" scope="component">
        <xd:desc>createNoteFrom362</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom362" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom500" scope="component">
        <xd:desc>createNoteFrom500</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom500" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <note>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-uri"/>
            <xsl:value-of select="f:proper-case(marc:subfield[@code = 'a'])"/>
        </note>
    </xsl:template>
    <xd:doc id="marcPrefix-createNoteFrom502" scope="component">
        <xd:desc>createNoteFrom502</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom502" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom504" scope="component">
        <xd:desc>createNoteFrom504</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom504" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom508" scope="component">
        <xd:desc>createNoteFrom508</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom508" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom511" scope="component">
        <xd:desc>createNoteFrom511</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom511" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom515" scope="component">
        <xd:desc>createNoteFrom515</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom515" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom518" scope="component">
        <xd:desc>createNoteFrom518</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom518" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom524" scope="component">
        <xd:desc>createNoteFrom524</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom524" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom530" scope="component">
        <xd:desc>createNoteFrom530</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom530" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom533" scope="component">
        <xd:desc>createNoteFrom533</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom533" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-createNoteFrom535" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom536" scope="component">
        <xd:desc>createNoteFrom536</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom536" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom538" scope="component">
        <xd:desc>createNoteFrom538</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom538" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom541" scope="component">
        <xd:desc>createNoteFrom541</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom541" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom545" scope="component">
        <xd:desc>createNoteFrom545</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom545" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom546" scope="component">
        <xd:desc>createNoteFrom546</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom546" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom561" scope="component">
        <xd:desc>createNoteFrom561</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom561" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom562" scope="component">
        <xd:desc>createNoteFrom562</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom562" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom581" scope="component">
        <xd:desc>createNoteFrom581</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom581" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom583" scope="component">
        <xd:desc>createNoteFrom583</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom583" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom585" scope="component">
        <xd:desc>createNoteFrom585</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom585" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNoteFrom5XX" scope="component">
        <xd:desc>createNoteFrom5XX</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNoteFrom5XX" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <note>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-uri"/>
            <xsl:variable name="str">
    ...
    <xsl:template name="marcPrefix-createNoteFrom910"
    ...
    <xsl:template name="marcPrefix-createNoteFrom930"
    ...
    <xsl:template name="marcPrefix-createNoteFrom945"
    ...
    <xsl:template name="marcPrefix-createNoteFrom946" match="marc:datafield[@tag = 946]/marc:subfield[@code = 'a']" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xsl:template name="marcPrefix-createNoteFrom974"
        match="marc:datafield[@tag = 974]/marc:subfield[@code = 'a' or @code = 'b']" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        ...
        <xsl:if test="marc:datafield[@tag = 974]">
            <identifier type="local">
                ...
                <xsl:if
                    test="count(marc:datafield[@tag = 974]/marc:subfield[@code = 'b']) != 0">
                    <xsl:text>&#160;</xsl:text>
                    <xsl:value-of select="normalize-space(marc:datafield[@tag = 974]/marc:subfield[@code = 'b'])"/>
                </xsl:if>
            </identifier>
        </xsl:if>
    </xsl:template>

    <xd:doc id="marcPrefix-createSubGeoFrom034" scope="component">
        <xd:desc> subject Geo 034 043 045 255 656 662 752 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubGeoFrom034" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <xsl:if
    ...
    <xd:doc id="marcPrefix-createSubGeoFrom043" scope="component">
        <xd:desc>subject Geo 043 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubGeoFrom043" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
    ...
    <xd:doc id="marcPrefix-createSubGeoFrom255" scope="component">
        <xd:desc>subject Geo 255 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubGeoFrom255" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <cartographics>
                <xsl:for-each select="marc:subfield[@code = 'a' or @code = 'b' or @code = 'c']">
    ...
    <xd:doc id="marcPrefix-createSubNameFrom600" scope="component">
        <xd:desc>subject GeoName 600</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubNameFrom600" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-subjectAuthority"/>
            <name type="personal">
                <xsl:call-template name="marcPrefix-termsOfAddress"/>
                <namePart>
                    <xsl:call-template name="chopPunctuation">
            ...
            <xsl:call-template name="marcPrefix-subjectAnyOrder"/>
        </subject>
    </xsl:template>

    <xd:doc id="marcPrefix-createSubNameFrom610" scope="component">
        <xd:desc>createSubNameFrom610</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubNameFrom610" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createSubNameFrom611" scope="component">
        <xd:desc>createSubNameFrom611</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubNameFrom611" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createSubTitleFrom630" scope="component">
        <xd:desc>createSubTitleFrom630</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubTitleFrom630" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-subjectAuthority"/>
            <titleInfo>
    ...
    <xd:doc id="marcPrefix-createSubChronFrom648" scope="component">
        <xd:desc>createSubChronFrom648</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubChronFrom648" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:if test="marc:subfield[@code = '2']">
                <xsl:attribute name="authority">
    ...
    <xd:doc id="marcPrefix-createSubTopFrom650" scope="component">
        <xd:desc>createSubTopFrom650</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubTopFrom650" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:call-template name="marcPrefix-subjectAuthority"/>
            <topic>
    ...
    <xd:doc id="marcPrefix-createSubGeoFrom651" scope="component">
        <xd:desc>createSubGeoFrom651</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubGeoFrom651" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createSubFrom653" scope="component">
        <xd:desc>createSubFrom653</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubFrom653" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createSubFrom656" scope="component">
        <xd:desc>createSubFrom656</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubFrom656" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
            <xsl:if test="marc:subfield[@code = '2']">
                <xsl:attribute name="authority">
    ...
    <xd:doc id="marcPrefix-createSubGeoFrom662752" scope="component">
        <xd:desc>createSubGeoFrom662752</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubGeoFrom662752" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <subject>
            <xsl:call-template name="marcPrefix-xxx880"/>
    ...
    <xd:doc id="marcPrefix-createSubTemFrom045" scope="component">
        <xd:desc>createSubTemFrom045</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createSubTemFrom045" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <xsl:if test="//marc:datafield[@tag = 045 and @ind1 = '2'][marc:subfield[@code = 'b' or @code = 'c']]">
            <subject>
                <xsl:call-template name="marcPrefix-xxx880"/>
                <temporal encoding="iso8601" point="start">
                    <xsl:call-template name="marcPrefix-dates045b">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom050" scope="component">
        <xd:desc>createClassificationFrom050</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom050" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom060" scope="component">
        <xd:desc>createClassificationFrom060</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom060" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom080" scope="component">
        <xd:desc>createClassificationFrom080</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom080" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom082" scope="component">
        <xd:desc>createClassificationFrom082</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom082" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom084" scope="component">
        <xd:desc>createClassificationFrom084</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom084" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createClassificationFrom086" scope="component">
        <xd:desc>createClassificationFrom086</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createClassificationFrom086" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createRelatedItemFrom490" scope="component">
        <xd:desc> createRelatedItemFrom490 &lt;xsl:for-each
            select="marc:datafield[@tag=490][@ind1='0']"&gt; </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createRelatedItemFrom490" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <relatedItem type="series">
            <xsl:call-template name="marcPrefix-xxx880"/>
            <titleInfo>
                <title>
    ...
    <xd:doc id="marcPrefix-createLocationFrom852" scope="component">
        <xd:desc> location 852 856 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createLocationFrom852" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <location>
    ...
    <xd:doc id="marcPrefix-createLocationFrom856" scope="component">
        <xd:desc>createLocationFrom856</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createLocationFrom856" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
                    ...
                    <xsl:variable name="primary">
                        <xsl:choose>
                            ...
                            <xsl:when test="
                                    ...
                                    @ind2 != '2' and count(ancestor::record//marc:datafield[@tag = 856 and
                                    @ind2 = '0']) = 0 and count(ancestor::record//marc:datafield[@tag = 856 and
                                    @ind2 = '1']) = 0 and
    ...
    <extension>
        <xsl:for-each select="marc:datafield[@tag = '910']">
            <xsl:call-template name="marcPrefix-createNameFrom910"/>
        </xsl:for-each>
        <xsl:if test="marc:datafield[@tag = 859]">
            <location>
                <xsl:call-template name="marcPrefix-createLocationFrom859"/>
            </location>
        </xsl:if>
    </extension>

    <xd:doc id="marcPrefix-createLocationFrom859" scope="component">
        <xd:desc>createLocationFrom859</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createLocationFrom859" xpath-default-namespace="http://www.loc.gov/MARC21/slim">

        <xsl:for-each select="marc:datafield[@tag = 859]" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
            >
    ...
    <xd:doc id="marcPrefix-createAccessConditionFrom506" scope="component">
        <xd:desc> accessCondition 506 540 1.87 20130829</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createAccessConditionFrom506" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createAccessConditionFrom540" scope="component">
        <xd:desc>createAccessConditionFrom540</xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createAccessConditionFrom540" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
    ...
    <xd:doc id="marcPrefix-createNameFrom910" scope="component">
        <xd:desc> name affiliation 910 </xd:desc>
    </xd:doc>
    <xsl:template name="marcPrefix-createNameFrom910" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
        <affiliation>
            <xsl:if test="marc:subfield[@code = 'a']">
