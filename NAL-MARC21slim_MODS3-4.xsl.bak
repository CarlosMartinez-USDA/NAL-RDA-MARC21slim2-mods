...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:import href="marcPrefixedNAL-MARC21slim_MODS3-4.xsl"/>
...
<xsl:when test="//marc:collection/marc:record">
    <xsl:result-document encoding="UTF-8" version="1.0" method="xml"
        ...
        <xsl:call-template name="marcPrefix">
            <xsl:with-param name="marcPrefixedElement" xpath-default-namespace="http://www.loc.gov/MARC21/slim">
                <xsl:value-of select="."/>
            </xsl:with-param>
        </xsl:call-template>
    </xsl:result-document>
        ...
        <xsl:otherwise>   
                    ...
                    version="3.4" >
                        <xsl:for-each select="//record">
                            <xsl:call-template name="marcPrefix" xpath-default-namespace="http://www.loc.gov/MARC21/slim"/>
                        </xsl:for-each>
                    </mods>
                 </xsl:otherwise>
    </xsl:choose>
